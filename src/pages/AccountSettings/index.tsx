...
import { View, Box, Text, Input, InputField, ScrollView } from "@gluestack-ui/themed";
                    ...
                    <Box>
                        ...
                        <DropShadow
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate("ChangeAdress" as never)}>
                                <Box bgColor="#9A1915" mt={35} alignItems="center" justifyContent="center" height={45} borderRadius={10} mb={20}>

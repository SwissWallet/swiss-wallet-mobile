//@ts-nocheck
import { Box, Input, InputField, ScrollView, Text, View } from "@gluestack-ui/themed";
                        ...
                        <Box>
                            <TouchableOpacity onPress={ChangingPassword}>
                                <DropShadow style={{ shadowColor: "#000", shadowOffset: { width: 1, height: 3 }, shadowOpacity: 0.5, shadowRadius: 3 }}>
                                    <Box borderRadius={10} bgColor="#9A1915" alignItems="center" justifyContent="center" height={45} mb={20}>
